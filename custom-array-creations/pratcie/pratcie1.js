...
var student1 = Object.create(student, {
  ...
  town: { value: "nuthimadugu" },
  field: { value: "stack-developer" },
});
...
function bolloe(one, two1) {
  console.log(
    `My name is ${this.name} my work is ${one} and staying in ${two1}`
  );
}
//Call
bolloe.call(two1, "farmer", "kalyandurg");
//Apply
let arr23 = ["fullstack", "bangalore"];
bolloe.apply(one, arr23);
//Bind
...
console.log(bike);
let bikeone = Object.create(bike, {
  name: { value: "suziki" },
  model: { value: "2022" },
  engine: { value: "Bs4" },
  milage: { value: "45 k/h" },
  price: { value: "1 lakh 15 thousand" },
});
bikeone.name = "ganesh";
console.log(bikeone);
...
const outonee = new hello("praveen", "23", "bangalore", "full-stack", "male");
